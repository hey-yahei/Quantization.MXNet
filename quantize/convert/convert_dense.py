...
QuantizedArgs = namedtuple("DenseQuantizedArgs", "in_width wt_width quantize_input")
...
def gen_dense_converter(weight_width=8, input_width=8, quantize_input=False):
    def _converter(m):
        ...
        m.quantize_args = QuantizedArgs(in_width=input_width, wt_width=weight_width, quantize_input=quantize_input)
    return _converter
